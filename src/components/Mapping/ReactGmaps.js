...
const AnyReactComponent = ({  marker }) => <div className="InfoWindow"><img id={marker.key} src={marker.img_src} className="photoOnMap" style={{}} value={marker.lat}/><div>{marker.pseudo}, {marker.age}</div></div>;
